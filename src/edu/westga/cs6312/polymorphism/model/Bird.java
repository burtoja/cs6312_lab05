...
public abstract class Bird extends Animal{
	...
	/**
	 * 
	 * Constructor for Bird class which then constructs an Animal object of this kind with covering of feathers
	 *
	 * @param kind	type of Bird
	 *
	 * Precondition:
	 *
	 * Postcondition:	Animal object with type kind and covering of feathers
	 */
